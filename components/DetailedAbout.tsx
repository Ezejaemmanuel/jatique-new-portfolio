...
import { Code, Braces, Terminal, LayoutGrid, Cpu, Clock, Brush, CheckCircle, Smartphone } from "lucide-react";
...
const DetailedAbout = () => {
  ...
  const toolsAndTechnologies = [
    ...
    },
    {
      ...
      items: ["React Native", "Expo", "React Navigation", "Native Base", "Redux", "Reanimated"]
    },
    {
      category: "Backend",
        ...
        >
          <div className="bg-gray-900/40 backdrop-blur-lg rounded-2xl p-6 md:p-12 border border-rose-500/20 shadow-xl shadow-black/20">
            ...
            <div className="space-y-4 md:space-y-6 text-gray-200 text-sm md:text-lg">
              ...
              <p>
                As a full-stack developer with a passion for emerging technologies, I pride myself on staying at the forefront of web development, mobile development, blockchain, and AI innovations. I believe in the power of technology to solve real-world problems and create meaningful impact.
              </p>

              <p>
                Whether I&apos;m building decentralized applications that leverage the security and transparency of blockchain, creating cross-platform mobile apps with React Native and Expo, developing AI-powered tools that automate complex processes, or designing responsive web interfaces that delight users, I approach each challenge with excitement and dedication.
              </p>
